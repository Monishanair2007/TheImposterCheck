...
function openSocialAuthModal(provider) {
  ...
  if (p === "google") {
    ...
    elements.socialAuthEmail.value = "monisha@gmail.com";
  } else if (p === "github") {
    elements.socialModalIcon.innerHTML = `
    ...
    elements.socialAuthEmail.value = "Monisha";
  } else if (p === "apple") {
    elements.socialModalIcon.innerHTML = `
      <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
    ...
    elements.socialAuthEmail.value = "monisha@icloud.com";
  } else if (p === "microsoft") {
    elements.socialModalIcon.innerHTML = `
      <svg viewBox="0 0 24 24" width="24" height="24">
    ...
    elements.socialAuthEmail.value = "monisha@outlook.com";
  }

  elements.socialAuthName.value = "Monisha";
...
async function handleSocialPopupSubmit(e) {
  e.preventDefault();
  const name = elements.socialAuthName.value.trim() || "Monisha";
...
function handleQuickDemoLogin() {
  elements.loginEmail.value = "nemaan.thundiyil.btech2024@sitpune.edu.in";
...
async function screenSampleFile(filename) {
  ...
  try {
    ...
    await executeSingleScreening(file, "NEMAAN");
  } catch (err) {
    hideLoading();
...
function openProfileModal() {
  const user = state.user || {
    name: "Monisha",
    email: "nemaan.thundiyil.btech2024@sitpune.edu.in",
    role: "Lead Identity Specialist",
    avatar: "https://api.dicebear.com/7.x/bottts/svg?seed=Monisha",
