...
def list_sample_files():
    ...
    descriptions = {
        ...
        "11_match_monisha_selfie.png": {"title": "Matching Face Selfie (Photo)", "category": "Comparison Set", "expected": "MATCH", "desc": "Selfie matching Monisha ID (use in Multi-File Compare)."},
